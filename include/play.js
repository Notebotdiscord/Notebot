  ...
  async play(song, message, client, filters) {
    ...
    try {
      let embed = new MessageEmbed()
        ...
        .addField(":musical_note:  Requested by:", `>>> ${message.author.tag}`, true)
      ...
      switch (reaction.emoji.name) {
        ...
        case "🎵":
          ...
          let nowPlaying = new MessageEmbed()
            .setAuthor('♪Playing♪', 'https://i.redd.it/y3wduhwn4gd61.jpg', 'http://harmonymusic.tk')
        ...
        case "📑":
          ...
          let temEmbed = new MessageEmbed()
            .setAuthor("Searching...", ":mag:").setFooter("Lyrics")
            .setColor("#F0EAD6")
